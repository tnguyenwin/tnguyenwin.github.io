                    ...
                    <Row extraClasses='flex w-full lg:w-auto flex-col gap-1 items-center justify-center mt-8 mb-4 lg:m-0'>
                        ...
                        <ul className='mt-2 flex items-center gap-2'>
                            ...
                            <Link
                                ...
                                extraClasses={`${styleDefaults.backgroundColor} hover:border-[#BFBFBF] dark:hover:border-[#404040] border-2 ${styleDefaults.borderColor} shadow-lg ${styleDefaults.shadowColor} rounded-full h-full p-2 ${styleTemplates.navlinkHover}`}
                            />
                            {/* LinkedIn */}
                            <Link
                                isNavLink={false}
