    ...
    const coursesCategories = [
        {
            ...
            subItems: {
                0: 'MGMT 407 — Business Analytics--MGMT 405 — Management Communications--MGMT 360 — Financial Management--MGMT 321 — Accounting Concepts-Managers--MGMT 311 — Human Resource Management--BA 260 — Small Business Management--BA 226 — Business Law--BT 223 — MS Excel for Business — Expert--BT 165 — Introduction to the Accounting Cycle--BT 123 — MS Excel for Business',
                1: 'CS 297 — Programming Capstone--CS 296N — Web Development 2: ASP.NET--CS 295N — Web Development 1: ASP.NET--CS 280PR — Co-op Ed: Computer Programming--CS 276 — Database Systems and Modeling--CS 246 — System Design--CS 234N — Advanced Programming: C#--CS 233JS — Intermediate Programming: JavaScript--CS 206 — Co-op Ed: Computer Information Technology Seminar--CS 161N — Computer Science 1 (C# — Beginner)--CS 162N — Computer Science 2 (C# — Intermediate)--CS 133JS — Beg. Programming: JavaScript--CS 275 — Introduction to Database Systems and Modeling--CIS 195 — Web Authoring 1--CIS 125A — Software Tools: App Development--CIS 100 — Computing Careers Exploration--WR 227 — Technical Writing--WR 122 — Argument, Resch and Multi Comp',
