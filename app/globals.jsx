...
export const styleTemplates = {
    ...
    threeCanvas: `lg:rounded-[2vw] border-16 border-transparent bg-[radial-gradient(at_50%_50%,_rgb(227,227,224)_50%,_rgb(240,240,236)_75%,_rgb(227,227,224)_100%)] dark:bg-[radial-gradient(at_50%_50%,_rgb(28,28,31)_50%,_rgb(15,15,19)_75%,_rgb(28,28,31)_100%)] shadow-lg ${styleDefaults.shadowColor} outline outline-[#c3c3b3] dark:outline-[#3c3c4c] w-full lg:w-auto flex items-center justify-center relative aspect-square`,
